...
func runScenario(cmd RunCmd, manifest loadedManifest, scenario Scenario, nvimPath, configHome string, verbose bool) ScenarioResult {
	result := ScenarioResult{
		...
		ClientScope:       scenario.ClientScope,
		ExpectedNamespace: scenario.ExpectedNamespace,
		Status:            "failed",
	...
	env := []string{
		...
		"NVIM_BENCH_CLIENT_SCOPE=" + scenario.ClientScope,
		"NVIM_BENCH_EXPECTED_NAMESPACE=" + scenario.ExpectedNamespace,
