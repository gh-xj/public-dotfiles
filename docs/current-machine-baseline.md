...
| Raycast | App install plus public-safe script-command plan | Raycast account DB, extension cache, extension credentials, `raycast_env` |
...
| Homebrew brews | `gemini-cli`, `googleworkspace-cli`, `markdownlint-cli2`, `marksman`, `mole`, `pngpaste` |
...
1. Install Raycast.
2. Keep public-safe script commands in a repo-owned script directory.
3. Keep `raycast_env`, extension credentials, account sync, and private
