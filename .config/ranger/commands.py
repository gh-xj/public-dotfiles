...
class google_chrome(Command):
    ...
    def execute(self):
        ...
        fname = join(self.fm.thisdir.path, expanduser(self.rest(1)))
        os.system(f"open -a 'Google Chrome' {fname}")
...
class fzf_select_one_level(Command):
    """
    :fzf_select
    ...
    def execute(self):
        ...
        fzf = self.fm.execute_command(
            "ls -a | fzf --reverse --preview 'bat --style=numbers --color=always --line-range :500 {}'",
            env=env,
...
class fzf_select(Command):
    ...
    def execute(self):
        ...
        fzf = self.fm.execute_command(
            "fzf --reverse --preview 'bat --style=numbers --color=always --line-range :500 {}'",
            env=env,
            universal_newlines=True,
            stdout=subprocess.PIPE,
        )
