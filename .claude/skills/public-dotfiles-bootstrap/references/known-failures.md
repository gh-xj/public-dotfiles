...
| Bootstrap apply passes but the machine still feels off | diagnostic | Run `task dotfiles:converge && task check:full`, then inspect the narrow failing layer | `03c30c6`; convergence is a post-apply phase, not an ad hoc checklist |
