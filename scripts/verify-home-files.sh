...
assert_target_prefix ".codex/hooks.json" "/nix/store/"
assert_target_prefix ".codex/herdr-agent-state.sh" "/nix/store/"
assert_target_prefix ".claude/CLAUDE.md" "/nix/store/"
assert_target_prefix ".claude/hooks/herdr-agent-state.sh" "/nix/store/"
