...
assert_file ".config/herdr/config.toml"
...
assert_file ".codex/herdr-agent-state.sh"
...
assert_symlink_target ".config/herdr/config.toml" "/Users/example/public-dotfiles/.config/herdr/config.toml"
...
assert_symlink_target ".codex/hooks.json" "/Users/example/public-dotfiles/config/codex/hooks.json"
assert_symlink_target ".codex/herdr-agent-state.sh" "/Users/example/public-dotfiles/config/codex/herdr-agent-state.sh"
assert_target_prefix ".claude/CLAUDE.md" "/nix/store/"
assert_symlink_target ".claude/hooks" "/Users/example/public-dotfiles/.claude/hooks"
assert_symlink_target ".claude/settings.json" "/Users/example/public-dotfiles/.claude/settings.json"
